...
extern void drawSprite(const unsigned short*, unsigned int, unsigned int);
extern void drawSpritePart(const unsigned short*, unsigned int, unsigned int, const Rect*);
